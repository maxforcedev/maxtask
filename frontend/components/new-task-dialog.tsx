  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const newTask = {
        ...
        deadline: data.deadline ? format(data.deadline, "yyyy-MM-dd") : format(new Date(), "yyyy-MM-dd"),
        createdAt: format(new Date(), "yyyy-MM-dd"),
        subtasks: { completed: 0, total: validSubtasks.length },
      }
      ...
      toast({
        ...
        description: `"${data.title}" foi adicionada às suas tarefas.`,
      })
